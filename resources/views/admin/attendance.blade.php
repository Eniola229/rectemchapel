...
<div class="container mt-4">
    <div class="pagetitle">
        ...
        <p class="badge bg-success" id="status">Attendance Open</p>
    </div>

    <div class="d-flex justify-content-between align-items-center my-3">
        <h4>Today's Service: {{ $time->service ?? 'None Scheduled' }}</h4>
        <button class="btn btn-primary" id="scanFingerprint">
...
<script>
    ...
    let presentStudents = new Set(presentIds); // ✅ From DB
    ...
    document.getElementById('scanFingerprint').addEventListener('click', () => {
        ...
        .then(async res => {
            ...
            presentStudents.add(data.student.id); // ✅ Track by student.id
            updateLists();
        })
        .catch(err => {
